  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button 
              variant="ghost" 
              size="icon" 
              className="text-black/70 hover:text-black hover:bg-black/5 rounded-full"
              aria-label="Search"
            >
              <Search size={20} />
            </Button>
            ...
            <div className="flex flex-col space-y-4 px-6 py-8">
              ...
              <div className="pt-4 flex items-center">
                ...
                <Button 
                  variant="ghost" 
                  size="icon" 
                  className="text-black/70 hover:text-black hover:bg-black/5 rounded-full ml-2"
                  aria-label="Search"
                >
                  <Search size={20} />
                </Button>
      ...
      <Button
        variant="outline"
        size="icon"
        className={`fixed bottom-6 right-6 z-40 rounded-full bg-white/80 backdrop-blur-sm shadow-lg border border-gray-200 ${
