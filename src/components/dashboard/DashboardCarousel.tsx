  ...
  return (
    <>
      <div className="relative aspect-[16/9] bg-black">
        ...
        <button 
          onClick={prevSlide} 
          className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-white/10 hover:bg-white/30 rounded-full p-2 backdrop-blur-sm transition-all hover:scale-105 border border-white/20"
        ...
        <button 
          onClick={nextSlide} 
          className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-white/10 hover:bg-white/30 rounded-full p-2 backdrop-blur-sm transition-all hover:scale-105 border border-white/20"
