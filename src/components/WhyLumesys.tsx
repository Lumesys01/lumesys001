      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="glass-card rounded-xl p-8 md:p-12 text-center">
            <h3 className="text-xl font-medium mb-2">Average Energy Savings</h3>
          ...
          <div className="glass-card rounded-xl overflow-hidden">
            <div className="grid grid-cols-3 text-center p-4 bg-darkblue">
              <div className="font-medium">Feature</div>
              <div className="font-medium text-highlight">Lumesys</div>
              <div className="font-medium text-white/70">Traditional</div>
            </div>
            ...
            {comparisonData.map((item, index) => (
              <div key={index} className="grid grid-cols-3 text-center p-4 border-t border-border">
                ...
                <div className="flex items-center justify-center text-white/70">
                  <X className="w-5 h-5 text-white/40 mr-1" />
        ...
        <div className="mt-16 glass-card rounded-xl p-8 relative overflow-hidden group">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <Button className="glow-border bg-surface backdrop-blur-sm px-6 py-5 rounded-full text-white group">
